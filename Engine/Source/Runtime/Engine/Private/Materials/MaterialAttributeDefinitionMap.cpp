...
///这是新版ue的 MaterialAttributeDefinitionMap.cpp文件
...
FText FMaterialAttributeDefinitionMap::GetAttributeOverrideForMaterial(const FGuid& AttributeID, UMaterial* Material)
{
	...
	case MP_SubsurfaceColor:
		...
		CustomPinNames.Add({ MSM_CelToon, TEXT("CelToonSubsurfaceColor") }); //LYY 新版本在这
	...
	case MP_CustomData0:
		...
		CustomPinNames.Add({ MSM_CelToon, TEXT("Range") }); //LYY 新版本在这
